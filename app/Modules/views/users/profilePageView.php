...
start_page("Mon Profil - BDE Inform'Aix", true, $user ?? null);
                ...
                <?php if ($editField === 'user_status') : ?>
                    ...
                    <form method="POST" action="index.php?page=profile&action=processUserStatus" class="profile-edit-form">
                        ...
                        <select name="user_status" class="profile-select" required autofocus>
                            ...
                            <option value="BUT 1" <?= ($user['user_status'] ?? '') === 'BUT 1' ? 'selected' : '' ?>>BUT 1</option>
                            <option value="BUT 2" <?= ($user['user_status'] ?? '') === 'BUT 2' ? 'selected' : '' ?>>BUT 2</option>
                            <option value="BUT 3" <?= ($user['user_status'] ?? '') === 'BUT 3' ? 'selected' : '' ?>>BUT 3</option>
