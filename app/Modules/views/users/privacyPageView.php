 ...
 * @var array{can_resend: bool, wait_seconds: int, resend_count: int} $passwordResendStatus Password resend code status
 * @var array{can_resend: bool, wait_seconds: int, resend_count: int} $emailResendStatus Email resend code status
