...
function start_page(string $title, bool $wouldNav = true, ?array $user = null): void
{
    ...
    <head>
        ...
        <!-- CSS Global (base + layout + components + themes) -->
                        ...
                        <?php if (isset($user) && $user !== null && $isAdmin) : ?>
                            ...
                            <li class="profile-dropdown-container">
                                ...
                                <div class="profile-dropdown-menu">
                                    ...
                                    <a href="index.php?page=deleteAccount" class="dropdown-danger"><i class="fas fa-trash-alt"></i>
    ...
    function end_page(): void
    {
        ...
        <footer>
            ...
            <div class="social-logos">
                <a href="https://www.instagram.com/informaix/" target="_blank" rel="noopener noreferrer" class="social-link"
                    aria-label="Instagram - Ouvrir dans un nouvel onglet">
                ...
                <a href="https://discord.gg/4dXHpN6JCK" target="_blank" rel="noopener noreferrer" class="social-link"
                    aria-label="Discord - Ouvrir dans un nouvel onglet">
                    <svg class="social-icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path
                ...
                <a href="https://www.tiktok.com/@informaix" target="_blank" rel="noopener noreferrer" class="social-link"
                    aria-label="TikTok - Ouvrir dans un nouvel onglet">
                    <svg class="social-icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path
