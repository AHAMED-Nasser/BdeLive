...
(function () {
    ...
    function loadView(view, params = {})
    {
        ...
        if (!calendarWrapper) {
            console.error('Wrapper .calendar-wrapper non trouvé');
            return;
        }
        ...
        fetch(url.toString())
            ...
            .then(data => {
                if (data.success && data.html) {
                    ...
                    // Les event listeners sont gérés par délégation d'événements,
                    // donc pas besoin de les réattacher après chaque chargement AJAX

                    // Réinitialiser l'indicateur de temps actuel si présent
                    if (typeof updateCurrentTimeIndicator === 'function') {
                        updateCurrentTimeIndicator();
                    }

                    // Réinitialiser les listeners du modal si nécessaire
                    ...
                    console.error('Erreur lors du chargement:', data.error || 'Erreur inconnue');
