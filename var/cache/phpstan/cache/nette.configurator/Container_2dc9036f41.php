...
class Container_2dc9036f41 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService04(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			[
				'analyseAndScan' => [
					'C:\wamp64\www\FORMATION\BUT\BdeLive\app\vendor\phpmailer',
					'C:\wamp64\www\FORMATION\BUT\BdeLive\app\vendor',
					'C:\wamp64\www\FORMATION\BUT\BdeLive\vendor',
				],
				'analyse' => [],
			]
		);
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_2dc9036f41 $container)
			{
	...
	public function createServiceContainer(): Container_2dc9036f41
	{
		return $this;
	}
